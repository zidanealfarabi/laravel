...
<body>
    ...
    .logo img {
        margin-right: 10px; /* Untuk memberikan jarak antara gambar dan teks */
        max-height: 50px; /* Sesuaikan sesuai kebutuhan */
    }
    ...
    .text-light {
        color: #ffffff; /* Ganti dengan warna teks yang diinginkan */
            ...
            <div class="logo">
            <img src="assets/img/blog/zidane.jpeg" alt="" class="img-fluid" >  
            <h1 class="text-light"><span>Programmer_PDBI</span></a></h1>
